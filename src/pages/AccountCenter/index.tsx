...
const operationTabList = [
  {
    ...
    tab: (
      <span>
        Open Area <span style={{ fontSize: 14 }}>(8)</span>
      </span>
    ),
  },
  {
    ...
    tab: (
      <span>
        Roof <span style={{ fontSize: 14 }}>(8)</span>
      </span>
    ),
  },
  {
    ...
    tab: (
      <span>
        ERP BOM <span style={{ fontSize: 14 }}>(8)</span>
      </span>
    ),
  },
  {
    ...
    tab: (
      <span>
        Query <span style={{ fontSize: 14 }}>(8)</span>
      </span>
    ),
  },
  {
    ...
    tab: (
      <span>
        Tools <span style={{ fontSize: 14 }}>(8)</span>
      </span>
    ),
  },
];
